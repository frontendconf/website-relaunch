...
module.exports = async (req, res) => {
  ...
  const cfsFields = [
    ...
    },
    {
      title: "Talk",
      description:
        "Please tell us about your presentation. If your talk should be accepted, the provided info will be used to announce you as a speaker on the official Front channels (including conference website and booklet).",
      fields: [
        {
          name: "Title",
          type: "text",
    ...
    },
    {
      ...
      fields: [
        ...
        { name: "Twitter", label: "Twitter / Mastodon", type: "text" },
  ...
  const fieldGroups = {
    ...
    "Invited Speakers": [
      ...
      },
      {
        ...
        description: `To be able to book travel and hotel, we would need to know some details. We are covering a round trip economy class airline or train ticket and accomodation at a <a href="https://www.motel-one.com/en/hotels/zurich/hotel-zurich/">hotel in the heart of Zurich</a>.<br><br>For speakers from overseas, we are covering up to 5 hotel nights, for speakers from Europe, we are covering up to 3 nights. For speakers from Switzerland, we are generally not covering any hotel nights, but do not hesitate to talk to us if this poses an issue.<br><br>If you are traveling with your partner, e.g., we can organize (and deduct from your honorarium or invoice) their airline or train ticket and upgrade the hotel to a double room (for a surcharge of about 35 CHF/night).`,
        fields: [
          {
